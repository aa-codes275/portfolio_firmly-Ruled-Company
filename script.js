...
document.addEventListener('DOMContentLoaded',()=>{
  ...
  form?.addEventListener('submit',e=>{
    ...
    const txt=`طلب استشارة قانونية%0Aالاسم: ${f[0].value}%0Aرقم الواتساب: ${f[1].value}%0Aنوع الاستشارة: ${f[2].value}%0Aالتفاصيل: ${f[3].value}`;
    msg.textContent='جاري تحويلك إلى واتساب...';
    window.open('https://wa.me/966555722599?text='+txt,'_blank');
    setTimeout(()=>{msg.textContent='✓ تم فتح واتساب، أرسل الرسالة وسنرد عليك سريعاً';form.reset();},900);
  });
